    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(max_length=200, upload_to='courses/', verbose_name='课程封面')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='创建时间')),
                ('coursesinfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.CoursesInfo', verbose_name='所属课程')),
            ],
            options={
                'verbose_name': '章节信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='创建时间')),
                ('courseinfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.CoursesInfo', verbose_name='课程资源')),
            ],
            options={
                'verbose_name': '资源信息',
